...
using Legacy.InGame.temp.System.FloatingDamage;
using Legacy.MainGame;
using Legacy.MainGame.Entity.Monster;
using Manager;
using Legacy.Scene.InGame.Card;
using Legacy.Scene.InGame.Entity.Interface;
using Legacy.Scene.InGame.Entity.Player;
using Legacy.Scene.InGame.Entity.Resource;
using Legacy.Scene.InGame.UI;
...
namespace Legacy.Scene.InGame
{
    public class InGameController : GameMonoInitializer
    {
        ...
        private Legacy.Scene.InGame.Entity.Touch.TouchEntityController touchController;
        [SerializeField]
        ...
        private Legacy.Scene.InGame.State.RunState _runState;

        public Legacy.Scene.InGame.State.RunState RunState => _runState;

        public async UniTask InitAsync()
        {
            // 게임 상태를 먼저 만듭니다. 튜닝 수치는 상수 시트에서 옵니다.
            _runState = new Legacy.Scene.InGame.State.RunState(Legacy.Scene.InGame.State.RunSettings.FromCurrentTable());
            ...
            if (cardHandController != null)
            {
                ...
                var skillContext = new Legacy.MainGame.Card.SkillCardContext(
                    getPlayer: () => _playerEntity,
                    getMonsters: () => monsterController.ActivateList.ConvertAll(m => (Legacy.Scene.InGame.Entity.Interface.IEntity)m),
        ...
        private async UniTaskVoid GameStart(float startDelay = 0.5f)
        {
            ...
            if (touchController != null)
                touchController.SetMonsterProvider(() =>
                    monsterController.ActivateList.ConvertAll(m => (Legacy.Scene.InGame.Entity.Interface.IEntity)m));
        ...
        private void SetGamePaused(bool paused)
        {
            ...
            Legacy.MainGame.Card.Effects.SkillEffectObjectBase.SetPausedAll(paused);
        }
        ...
        private System.Collections.Generic.IReadOnlyList<global::Data.SkillCardDataTableRow> TryRerollCards()
        {
            ...
            return Legacy.MainGame.Card.SkillDeck.PickRandomRewards(cardRewardCount);
        }
        ...
        private void ShowCardCleanupThen(System.Action next)
        {
            ...
            var rewards = Legacy.MainGame.Card.SkillDeck.PickRandomRewards(cardRewardCount);
        ...
        private void PrepareNextStage(bool advanceStage)
        {
            ...
            Legacy.MainGame.Card.Effects.SkillEffectObjectBase.ClearAll();
