...
using Data;
using Legacy.InGame.System.Skill.UI;
using Legacy.MainGame.Card;
using Manager;
using Legacy.Scene.InGame.Entity.Interface;
using UnityEngine;

namespace Legacy.Scene.InGame.Card
{
    ...
    public class CardHandController : GameMonoInitializer
    {
        ...
        private Legacy.Scene.InGame.UI.CardMessageUI cardMessage;

        [SerializeField]
        [Tooltip("조준 대상 머리 위 표시를 발급하는 풀 (선택)")]
        private global::Legacy.Scene.InGame.Entity.TargetMarkController targetMarkController;
