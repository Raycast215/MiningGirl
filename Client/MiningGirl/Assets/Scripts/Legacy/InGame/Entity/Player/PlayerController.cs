...
using Legacy.MainGame.Entity.Player.Cursor;
using Legacy.Scene.InGame.Entity.Data;
...
namespace Legacy.Scene.InGame.Entity.Player
{
    public class PlayerController : EntityControllerBase<Player>
    {
        ...
        public async UniTaskVoid InitAsync(IResourceProvider resourceProvider = null, global::Legacy.MainGame.Bonus.CharacterStatContext statContext = null)
        {
            if (IsInitialized)
                return;
